...
class APIServerAdapter(OpenAICompatRoutesMixin, BasePlatformAdapter):
    ...
    def _create_agent(
        ...
        stream_delta_callback=None, reasoning_callback=None, thinking_callback=None,
        status_callback=None, tool_progress_callback=None, tool_start_callback=None,
    ...
    async def _handle_model_options(self, request: "web.Request") -> "web.Response":
        ...
        try:
            from hermes_cli.inventory import (
                build_local_model_options_payload, build_model_options_payload, load_picker_context)
            ...
            def _build_payload() -> Dict[str, Any]:
                ...
                return build_model_options_payload(
                    context, include_unconfigured=True, refresh=refresh)
    ...
    async def _handle_session_chat_stream(self, request: "web.Request") -> "web.StreamResponse":
        ...
        def _thinking_update(text: str) -> None:
            events.enqueue("thinking.delta", {"message_id": message_id, "text": text or ""})

        def _status_update(kind: str, text: Optional[str] = None) -> None:
            events.enqueue("status.update", {
        ...
        async def _run_and_signal() -> None:
            try:
                ...
                result, usage = await self._run_agent(
                    ...
                    reasoning_callback=_reasoning_delta, thinking_callback=_thinking_update,
            ...
            with self._profile_scope(request_profile):
                ...
                try:
                    agent = self._create_agent(
                        ...
                        reasoning_callback=reasoning_callback, thinking_callback=thinking_callback,
                        status_callback=status_callback,
